...
#### 5.1 架构设计版本【包含V1.0, V2.0】
```
1、会员商业版线上环境地址，线上环境只对会员通道开放，成为会员：享受会员权益。线上环境：http://122.51.43.143:5173/ui_moat
  账号：test/123456（此账号只能体验数据质量功能）
2、开源版与商业版不是同一个项目，开源版会长期存在，商业版由公司团队维护。开源项目可以用于公司内部调研用途，如需商业使用，需要购买会员商业版，开源AllData项目使用GPL协议。
3、加入会员通道，购买商业版源码，可以商业使用AllData。商业版功能更多，保证稳定性，Bug比较少，由公司架构师团队维护。
4、V1.0旧版架构: 
